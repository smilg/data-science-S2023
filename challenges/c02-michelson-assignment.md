...
- Differences
  ...
  - The real data has more outliers. This makes sense to me, since I’d
    imagine including outliers in a model like this might just make a
    worse model (although I know nothing about models like this; that’s
    just a guess).
...
- The means from q1 showed this earlier, but it looks like measurements
  with lower distinctness generally have lower velocities.
