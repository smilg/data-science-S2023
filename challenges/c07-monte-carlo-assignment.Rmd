...
-   Was your sample size $n$ large enough? Why do you say that?
    -   I think my sample size was large enough since my confidence interval includes $\pi$, and the value of $\pi$ I estimated is accurate to the true value up to the hundredths place. When I rerun the code, this is true almost every time.
